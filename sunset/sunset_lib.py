...
if __name__ == '__main__':
    ...
    sun = Sun(56.328984, 43.999954)
    t = datetime.date(2018, 10, 1)

    print(sun.get_local_sunrise_time(t).replace(tzinfo=None))
    print(sun.get_local_sunset_time(t).replace(tzinfo=None))
